  ...
  return (
    <Box component="section" id="tecnologia" py={{ base: '4rem', md: '6rem' }} bg="gray.0" style={{ overflow: 'hidden' }}>
      <Container size="xl" px={{ base: 'md', md: 'xl' }} maw={contentMaxWidth}>
        ...
        <Box pos="relative" mb={{ base: 'xl', md: '4rem' }}>
          <Box pos="absolute" top={44} left={0} right={0} display={{ base: 'none', lg: 'block' }} className="ds-flow-line" />
              ...
              <Stack gap="lg">
                ...
                <SimpleGrid cols={2} spacing="md">
                  {dashboardRows.map((row) => (
                    <Paper key={row.left} p="lg" radius="xl" bg="rgba(255,255,255,0.05)" style={{ border: '1px solid rgba(255,255,255,0.12)' }}>
